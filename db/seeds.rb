...
# CAMPING ITEMS
camping_tag.items.create!(name: 'Folding Table')
camping_tag.items.create!(name: 'Canapy')
camping_tag.items.create!(name: 'Cozy Footware')
camping_tag.items.create!(name: 'Flashlight')
camping_tag.items.create!(name: 'Duct Tape')
camping_tag.items.create!(name: 'Air Mattress')
camping_tag.items.create!(name: 'Pillow')
camping_tag.items.create!(name: 'Blankets')
camping_tag.items.create!(name: 'Camp Stove')
camping_tag.items.create!(name: 'Firewood')
camping_tag.items.create!(name: 'Grill Grate')
camping_tag.items.create!(name: 'Water Bucket')
camping_tag.items.create!(name: 'Plates')
camping_tag.items.create!(name: 'Cups')
...
camping_tag.items.create!(name: 'Prepared Meals')
camping_tag.items.create!(name: 'Ukulele')
...
tarp = Item.create!(name: 'Tarp')
ItemTag.create!(item: tarp, tag: camping_tag)
ItemTag.create!(item: tarp, tag: backpacking_tag)
ItemTag.create!(item: tarp, tag: fishing_tag)
...
# BACKPACKING ITEMS
backpacking_tag.items.create!(name: 'Bear Resistant Canister')
backpacking_tag.items.create!(name: 'Bear Spray')
backpacking_tag.items.create!(name: 'Dehydrated Meals')
backpacking_tag.items.create!(name: 'Dried Foods')
backpacking_tag.items.create!(name: 'Satellite Communicator')
backpacking_tag.items.create!(name: 'Water Filtration System')

# FISHING ITEMS
fishing_tag.items.create!(name: 'Fishing License')
fishing_tag.items.create!(name: 'Fishing Hooks')
fishing_tag.items.create!(name: 'Hook Remover')
fishing_tag.items.create!(name: 'Fishing Line')
fishing_tag.items.create!(name: 'Fishing Net')
fishing_tag.items.create!(name: 'Fishing Reel')
fishing_tag.items.create!(name: 'Fishing Pole')
fishing_tag.items.create!(name: 'Fishing Vest')
fishing_tag.items.create!(name: 'Sinkers')
fishing_tag.items.create!(name: 'Bobbers')
fishing_tag.items.create!(name: 'Swivels')
fishing_tag.items.create!(name: 'Snaps')
fishing_tag.items.create!(name: 'Lures')
fishing_tag.items.create!(name: 'Live Bait')
fishing_tag.items.create!(name: 'Bait Alternatives')
fishing_tag.items.create!(name: 'Tackle Box')
fishing_tag.items.create!(name: 'Gaiters')
fishing_tag.items.create!(name: 'Pliers')

# CLIMBING ITEMS
climbing_tag.items.create!(name: 'Climbing Shoes')
climbing_tag.items.create!(name: 'Approach Shoes')
climbing_tag.items.create!(name: 'Chalk Bag')
climbing_tag.items.create!(name: 'Chalk')
climbing_tag.items.create!(name: 'Harness')
climbing_tag.items.create!(name: 'Belay Device')
climbing_tag.items.create!(name: 'Locking Carabiner')
climbing_tag.items.create!(name: 'Non-Locking Carabiner')
climbing_tag.items.create!(name: 'Climbing Rope')
climbing_tag.items.create!(name: 'Slings')
climbing_tag.items.create!(name: 'Quickdraws')
climbing_tag.items.create!(name: 'Cams')
climbing_tag.items.create!(name: 'Nuts')
climbing_tag.items.create!(name: 'Hexes')
climbing_tag.items.create!(name: 'Ascenders')
climbing_tag.items.create!(name: 'Descenders')
climbing_tag.items.create!(name: 'Personal Anchor System')

# KAYAKING ITEMS
kayaking_tag.items.create!(name: 'Kayak')
kayaking_tag.items.create!(name: 'Paddle')
kayaking_tag.items.create!(name: 'Spray Skirt')
kayaking_tag.items.create!(name: 'Bilge Pump')
kayaking_tag.items.create!(name: 'Paddle Leash')
kayaking_tag.items.create!(name: 'Kayak Repair Kit')
kayaking_tag.items.create!(name: 'Throw Rope')
kayaking_tag.items.create!(name: 'Dry Bag')
kayaking_tag.items.create!(name: 'Second Dry Bag')

# MOUNTAIN BIKING ITEMS
mtn_bike_tag.items.create!(name: 'Mountain Bike')
mtn_bike_tag.items.create!(name: 'Bike Shoes')
mtn_bike_tag.items.create!(name: 'Platform Pedals')
mtn_bike_tag.items.create!(name: 'Clipless Pedals')
mtn_bike_tag.items.create!(name: 'Spare Tubes')
mtn_bike_tag.items.create!(name: 'Tubeless Repair Kit')
mtn_bike_tag.items.create!(name: 'Tire Pump')
mtn_bike_tag.items.create!(name: 'Tire Levers')
mtn_bike_tag.items.create!(name: 'Chain Tool')
mtn_bike_tag.items.create!(name: 'Spare Chain Links')
mtn_bike_tag.items.create!(name: 'Chain Lubricant')
mtn_bike_tag.items.create!(name: 'Suspension Pump')
mtn_bike_tag.items.create!(name: 'Bike Lock')
mtn_bike_tag.items.create!(name: 'Bike Lights')
mtn_bike_tag.items.create!(name: 'Padded Cycling Shorts')
mtn_bike_tag.items.create!(name: 'Cycling Socks')
mtn_bike_tag.items.create!(name: 'Knee Pads')
mtn_bike_tag.items.create!(name: 'Elbow Pads')
mtn_bike_tag.items.create!(name: 'Bike Bell')
mtn_bike_tag.items.create!(name: 'Reflective Gear')
mtn_bike_tag.items.create!(name: 'Bike Repair Instructions')
...
ItemTag.create!(item: hiking_boots, tag: fishing_tag)
